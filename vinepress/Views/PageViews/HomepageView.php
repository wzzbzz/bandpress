...
<div class="container">
  <div class="row">
    ...
    <span class="heading-4">Please choose your destination</span>
    </div>
    ...
    <div class="col-sm col-lg-8">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Pick NBA Games against the spread in a friendly contest against a other humans and a random Chicken!</p>
